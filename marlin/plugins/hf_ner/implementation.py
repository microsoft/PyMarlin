...
from marlin.models import MarlinAutoModelForTokenClassification
...
class HfNERPlugin(Plugin):
    ...
    def setup_datainterface(self):
        ...
        if self.data_args.train_dir is not None:
            ...
            train_features = self.datainterface.multi_process_data(self.dataprocessor, train_files, tokenizer, process_count=multiprocessing.cpu_count())
        ...
        if self.data_args.val_dir is not None:
            ...
            val_features = self.datainterface.multi_process_data(self.dataprocessor, val_files, tokenizer, process_count=multiprocessing.cpu_count())
