...
class MarlinAutoModelForSequenceClassification(AutoModelForSequenceClassification):
    ...
    def from_config(cls, config):
        ...
        Example::
            ...
            >>> from marlin.models.auto.configuration_auto import MarlinAutoConfig
            >>> from marlin.models.auto.modeling_auto import MarlinAutoModelForSequenceClassification
            >>> config = MarlinAutoConfig.from_pretrained("turingv1-base-uncased")
...
class MarlinAutoModelForTokenClassification(AutoModelForTokenClassification):
    ...
    def from_config(cls, config):
        ...
        Example::
            ...
            >>> from marlin.models.auto.configuration_auto import MarlinAutoConfig
            >>> from marlin.models.auto.modeling_auto import MarlinAutoModelForTokenClassification
            >>> config = MarlinAutoConfig.from_pretrained("turingv1-base-uncased")
