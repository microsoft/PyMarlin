...
class TuringV1Model(BertModel):
    ...
    Example:
        ...
        >>> from pymarlin.models.turingv1.configuration_turingv1 import TuringV1Config
        >>> from pymarlin.models.turingv1.modeling_turingv1 import TuringV1Model
...
class TuringV1ModelForPretraining(BertPreTrainedModel):
    ...
    Example:
        ...
        >>> from pymarlin.models.turingv1.configuration_turingv1 import TuringV1Config
        >>> from pymarlin.models.turingv1.modeling_turingv1 import TuringV1ModelForPretraining
        >>> config = TuringV1Config()
