...
class PluginModuleInterface(module_interface.ModuleInterface):
    ...
    def setup_tokenizer(self):
        ...
        if self.args.model_args.tokenizer_path is not None:
            tokenizer = AutoTokenizer.from_pretrained(self.args.model_args.tokenizer_path)
        else:
    ...
    def setup_model_config(self):
        ...
        model_config.num_labels = len(self.data.get_labels()) if hasattr(self.data, 'get_labels') else None
    ...
    def setup_model(self, automodel_class):
        ...
        """
        if self.args.model_args.model_path is not None and self.args.model_args.model_file is not None:
